...
const buttonVariants = cva(
    "flex items-center justify-center rounded-lg font-medium text-white duration-100 dark:text-black disabled:bg-indigo-400 disabled:hover:bg-indigo-400 disabled:cursor-not-allowed ",
    {
        variants: {
            variant: {
                // ** FILLED
                default: "bg-transparent mx-auto border-2 border-indigo-500 dark:bg-indigo-600 dark:text-white dark:hover:bg-indigo-700 active:bg-indigo-600 hover:bg-indigo-500",
