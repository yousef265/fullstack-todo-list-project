        ...
        <div className="fixed inset-0 flex items-center justify-center p-5 w-full bg-white">
            <div className="text-center">
                ...
                <div className="flex items-center justify-center space-x-4 my-10">
                    <Link to={"/"} className="inline-block bg-indigo-600 p-2 text-white hover:!text-white rounded-md" reloadDocument>
                        Home
                    </Link>
                    <Link to={pathname} className="inline-block bg-indigo-600 p-2 text-white hover:!text-white rounded-md" reloadDocument>
                        Refresh
                    </Link>
                </div>
            </div>
